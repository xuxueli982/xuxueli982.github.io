...
public static void main(String[] args) {
    ...
    ExecutorService service = Executors.newCachedThreadPool();
    service.execute(()->synchronizedExample.func1());
    service.execute(()->synchronizedExample.func1());
}
```
...
public static void main(String[] args) {
    ...
    service.execute(()->signalExample.after());
    service.execute(()->signalExample.before());
}
```
...
[Untitled](https://www.notion.so/f08440d9f21c480b8c594ac1b92b366d)

### 限期等待（TIMED_WAITING）

无需等待其它线程显式地唤醒，在一定时间之后会被系统自动唤醒。

[Untitled](https://www.notion.so/465ddad454134898b996d6f229244e62)
...
![](68747470733a2f2f63732d6e6f7465732d313235363130393739362e636f732e61702d6775616e677a686f752e6d7971636c6f75642e636f6d2f62613037383239312d373931652d343337382d623664312d6563653736633266306231342e706e67)
...
[Java%20%E5%B9%B6%E5%8F%91%20114f4bbf6f21495082c070c27de9b0e5/](Java%20%E5%B9%B6%E5%8F%91%20114f4bbf6f21495082c070c27de9b0e5/)
...
![](68747470733a2f2f63732d6e6f7465732d313235363130393739362e636f732e61702d6775616e677a686f752e6d7971636c6f75642e636f6d2f39343263613064322d396435632d343561342d383963622d3566643839623631393133662e706e67)
...
![](Java-Concurrency/68747470733a2f2f63732d6e6f7465732d313235363130393739362e636f732e61702d6775616e677a686f752e6d7971636c6f75642e636f6d2f32373937613630392d363864622d346437622d383730312d3431616339613334623134662e6a7067)
...
![](68747470733a2f2f63732d6e6f7465732d313235363130393739362e636f732e61702d6775616e677a686f752e6d7971636c6f75642e636f6d2f32333366386438392d333164372d343133662d396330322d3034326631396334366261312e706e67)
...
Exception in thread "main" java.lang.UnsupportedOperationException
	...
	at com.xxl.concurrency.ImmutableExample.main(ImmutableExample.java:18)
```
...
```java
public static void main(String[] args) {
        StackCloseExample closeExample = new StackCloseExample();
        ExecutorService service = Executors.newCachedThreadPool();
        service.execute(()->closeExample.add100());
        service.execute(()->closeExample.add100());
        service.shutdown();
    }
```
...
![](68747470733a2f2f63732d6e6f7465732d313235363130393739362e636f732e61702d6775616e677a686f752e6d7971636c6f75642e636f6d2f30353165343336632d306534362d346335392d386636372d3532643839643635363138322e706e67)
